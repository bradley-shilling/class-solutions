...
public class KataNumbersToWordsTest {
	...
	public void should_return_over_1000() {
		...
		assertEquals("nine hundred eighty seven million six hundred fifty four thousand three hundred twenty one", kntw.numberToWords(987654321));
		assertEquals("nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine", kntw.numberToWords(999999999));
	}
	...
	public void many_words_to_number() {
		...
		assertEquals(987654321, kntw.wordsToNumber("nine hundred eighty seven million six hundred fifty four thousand three hundred twenty one"));
		assertEquals(999999999, kntw.wordsToNumber("nine hundred ninety nine million nine hundred ninety nine thousand nine hundred ninety nine"));
	}
