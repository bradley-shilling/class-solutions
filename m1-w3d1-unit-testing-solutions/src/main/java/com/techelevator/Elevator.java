...
public class Elevator {
    ...
    public Elevator(int shaftNumber, int totalNumberOfFloors) {
        ...
        this.currentLevel = 1;
        this.doorOpen= true; // Door is open,
        this.moving = false; // and elevator is waiting for its first passenger(s) 
    }
    ...
    {
        if (desiredFloor < currentLevel && desiredFloor > 0 && !doorOpen)
        {
            currentLevel = desiredFloor;
            return true;
        }
